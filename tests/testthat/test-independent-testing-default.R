...
test_that("defalut values for name=apata", {
  expect_equal(c(x$name, x$id, x$group, x$var, x$subset , x$label) , 
...
test_that("defalut values for name=apr", {
  expect_equal(c(y$name, y$id, y$group, y$var, y$subset , y$label) , 
...
test_that("defalut values for name=apt", {
  expect_equal(c(z$name, z$id, z$group, z$var, z$subset , z$label) , 
...
test_that("defalut values for name=asat", {
  expect_equal(c(a$name, a$id, a$group, a$var, a$subset , a$label) , 
...
test_that("defalut values for name=asr", {
  expect_equal(c(b$name, b$id, b$group, b$var, b$subset , b$label) , 
...
test_that("defalut values for name=ast", {
  expect_equal(c(c$name, c$id, c$group, c$var, c$subset , c$label) , 
